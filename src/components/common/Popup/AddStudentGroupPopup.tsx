...
export default function AddStudentGroupPopup({ onClosePopUp }: Props) {
  ...
  const [selectedSubProgramName, setSelectedSubProgramName] =
    useState<string>("");
  const [resolvedProgramId, setResolvedProgramId] = useState<number | null>(
    null
  );
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <select
                value={groupClass}
                onChange={(e) =>
                  setGroupClass(e.target.value as "ปวช" | "ปวส" | "")
                }
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                * เมื่อเลือกระดับแล้ว ระบบจะบังคับให้ชื่อห้องขึ้นต้นด้วย{" "}
                <b>{level || "x"}/</b>
              </p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border px-3 py-2 rounded"
                disabled={
                  !selectedFaculty || loadingPrograms || !!programsError
                }
              >
                <option value="">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border px-3 py-2 rounded"
                disabled={
                  !selectedProgramName || loadingPrograms || !!programsError
                }
              >
                <option value="">
