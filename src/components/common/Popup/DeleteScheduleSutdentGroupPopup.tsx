...
import { ScheduleItemStudentGroups } from "@/dto/studentGroupItem";
import { TeacherScheduleItem } from "@/dto/teacherDto";
import { toast } from "react-toastify";

interface PropsDelete {
  onClosePopup: (open: boolean) => void;
  scheduleData: ScheduleItemStudentGroups;
}

export default function DeleteScheduleSutdentGroupPopup({
  onClosePopup,
  scheduleData,
}: PropsDelete) {
