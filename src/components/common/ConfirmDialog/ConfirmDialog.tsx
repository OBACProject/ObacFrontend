...
export default function ConfirmDialog({
  ...
  return (
    <div
      className="fixed inset-0 flex items-center justify-center bg-gray-700 bg-opacity-45 z-50"
      onClick={onClose}
    >
      <div
        className="bg-white shadow-lg shadow-gray-400 rounded-lg w-4/12 min-w-[400px] max-w-lg mx-4"
