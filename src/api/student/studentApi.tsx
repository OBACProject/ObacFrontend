...
export const fetchCreateStudentAsync = async (
  ...
  try {
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/CreateStudent`,
      {
        method: "POST",
        headers: {
...
export const fetchGetAllStudentGroup = async (): Promise<StudentGroup[]> => {
  ...
  try {
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/GetAllStudentGroup`,
      {
        method: "GET",
        headers: {
...
export const fetchStudentUser = async (): Promise<GetStudentUser> => {
  try {
    ...
    const token = cookies().get("token")?.value;
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/GetStudentByUserId?userId=${userId}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const GetStudentListByGroupID = async (
  ...
  try {
    const token = cookies().get("token")?.value;
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/GetStudentListByGroupID?groupid=${groupId}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchGetStudentByStudentId = async (
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/GetStudentByStudentID?studentId=${studentId}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchGetStudentGroupsByTermYear = async (
  ...
  try {
    ...
    if (!token) throw new Error("Missing authentication token");
    const response = await fetch(
      `${process.env.API_URL_V1}/Student/GetStudentGroupsByTermYear?term=${term}&year=${year}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
