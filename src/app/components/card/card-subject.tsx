...
export default function CardSubject({ cardSubjectData }: CardSubjectProps) {
  return (
          <div
            className=" border-[1px] hover:border-black border-gray-200 rounded-md my-3 bg-card text-card-foreground w-full hover:scale-[102%] duration-500 hover:bg-gray-50 shadow-md shadow-gray-200 bg-white grid grid-cols-[40%_21%_3%_36%]"
