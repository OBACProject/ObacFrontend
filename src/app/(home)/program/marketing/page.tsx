...
export default function Page() {
  ...
  const iconPositions = [
    {
      src: "/cls/marketing/marketing_light.png",
      alt: "Light Bulb",
    ...
    {
      src: "/cls/marketing/marketing_chart.png",
      alt: "Chart",
    ...
    {
      src: "/cls/marketing/marketing_arrow.png",
      alt: "Target Arrow",
    ...
    {
      src: "/cls/marketing/marketing_coin.png",
      alt: "Coin",
    ...
    {
      src: "/cls/marketing/marketing_cart.png",
      alt: "Shopping Cart",
    ...
    {
      src: "/cls/marketing/marketing_global.png",
      alt: "Global",
    ...
    {
      src: "/cls/marketing/marketing_mail.png",
      alt: "Mail",
    ...
    {
      src: "/cls/marketing/marketing_graph.png",
      alt: "Graph",
