...
export default function Page() {
  ...
  const iconPositions = [
    { src: "/cls/tourism-management/tourism_air.png", alt: "Light Bulb", position: { top: "15%", left: "25%" }, parallaxStrength: 0.3, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_bag.png", alt: "Chart", position: { top: "20%", right: "15%" }, parallaxStrength: 0.4, size: "w-8 h-8 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_cam.png", alt: "Target Arrow", position: { bottom: "25%", right: "10%" }, parallaxStrength: 0.5, size: "w-14 h-14 sm:w-18 sm:h-18" },
    { src: "/cls/tourism-management/tourism_clound.png", alt: "Coin", position: { bottom: "55%", left: "40%" }, parallaxStrength: 0.3, size: "w-14 h-10 sm:w-20 sm:h-16" },
    { src: "/cls/tourism-management/tourism_doublewood.png", alt: "Shopping Cart", position: { bottom: "15%", left: "35%" }, parallaxStrength: 0.4, size: "w-12 h-12 sm:w-18 sm:h-18" },
    { src: "/cls/tourism-management/tourism_map.png", alt: "Global", position: { bottom: "10%", left: "50%" }, parallaxStrength: 0.2, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_sun.png", alt: "Mail", position: { top: "25%", left: "10%" }, parallaxStrength: 0.3, size: "w-8 h-8 sm:w-14 sm:h-14" },
    { src: "/cls/tourism-management/tourism_wood.png", alt: "Graph", position: { top: "40%", left: "5%" }, parallaxStrength: 0.4, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_world.png", alt: "Graph", position: { top: "15%", left: "65%" }, parallaxStrength: 0.4, size: "w-10 h-10 sm:w-16 sm:h-16" },
  ];
