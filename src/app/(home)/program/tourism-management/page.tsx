...
export default function Page() {
  ...
  const iconPositions = [
    { src: "/cls/tourism-management/tourism_air.png", alt: "Airplane", position: { top: "15%", left: "25%" }, parallaxStrength: 0.3, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_bag.png", alt: "Bag", position: { top: "20%", right: "15%" }, parallaxStrength: 0.4, size: "w-8 h-8 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_cam.png", alt: "Camera", position: { bottom: "25%", right: "10%" }, parallaxStrength: 0.5, size: "w-14 h-14 sm:w-18 sm:h-18" },
    { src: "/cls/tourism-management/tourism_clound.png", alt: "Cloud", position: { bottom: "55%", left: "40%" }, parallaxStrength: 0.3, size: "w-14 h-10 sm:w-20 sm:h-16" },
    { src: "/cls/tourism-management/tourism_doublewood.png", alt: "Wood", position: { bottom: "15%", left: "35%" }, parallaxStrength: 0.4, size: "w-12 h-12 sm:w-18 sm:h-18" },
    { src: "/cls/tourism-management/tourism_map.png", alt: "Map", position: { bottom: "10%", left: "50%" }, parallaxStrength: 0.2, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_sun.png", alt: "Sun", position: { top: "25%", left: "10%" }, parallaxStrength: 0.3, size: "w-8 h-8 sm:w-14 sm:h-14" },
    { src: "/cls/tourism-management/tourism_wood.png", alt: "Wood", position: { top: "40%", left: "5%" }, parallaxStrength: 0.4, size: "w-10 h-10 sm:w-16 sm:h-16" },
    { src: "/cls/tourism-management/tourism_world.png", alt: "World", position: { top: "15%", left: "65%" }, parallaxStrength: 0.4, size: "w-10 h-10 sm:w-16 sm:h-16" },
  ];
        ...
        <div className="absolute inset-0 sm:hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 flex justify-center z-10">
            <Image
              ...
              width={900}
              height={900}
              className={`h-[180px] w-auto object-contain drop-shadow-2xl translate-x-4 sm:translate-x-0 transition-all duration-1000 ${
        ...
        <FadeInOnScroll>
          <div className="relative w-full py-5 sm:py-12 md:py-16">
            <div className="relative w-full overflow-hidden rounded-2xl">
              <Image
                src="/program/program_tourism.jpg"
