              ...
              <MaybeParallax speed={5}>
                <div className="flex flex-col justify-start space-y-4 text-sm sm:text-base md:text-lg leading-relaxed pt-0">
                  ...
                  <p className="indent-8">
                    วิสัยทัศน์ทางการศึกษาและความตั้งใจจริงของคุณมยุรีและคุณวิทวัต
                    โยธินนรธรรมที่มองเห็นถึงความสำคัญของเยาวชนไทย
                    จึงได้จัดตั้ง วิทยาลัยอาชีวศึกษาเอกวิทย์บริหารธุรกิจ ซึ่งเป็นโรงเรียนอาชีวศึกษาเอกชนขึ้นเมื่อวันที่ 23 มิถุนายน
                    2541
                  </p>
                  <p className="indent-8">
