            ...
            <section className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-10 text-sm sm:text-base md:text-lg leading-relaxed">
              <div className="text-center space-y-4">
                ...
                <div className="mx-auto w-6/12 max-w-3xl flex justify-center gap-4 text-white font-bold text-lg pt-20">
                  <div className="flex-1 aspect-square bg-blue-900 flex items-center font-prompt text-3xl justify-center rounded">
                    น้ำเงิน
                  </div>
                  <div className="flex-1 aspect-square bg-gray-400 flex items-center font-prompt text-3xl justify-center rounded text-gray-900">
                    เทา
                  </div>
                </div>
              ...
              <div className="space-y-3 pt-20">
                ...
                <p className="indent-8">
                  ...
                  มุ่งหวังพัฒนาการเรียนการสอนสู่ความเป็นเลิศทางวิชาการ
                  และให้ผู้เรียนมีคุณธรรม
                  มีทักษะที่สามารถนำความรู้ที่ได้ไปประยุกต์ใช้ในการดำรงตนในสังคมได้
              ...
              <div className="space-y-6 pt-20 text-center">
                ...
                <div className="inline-block text-left">
                  <ol className="list-decimal list-inside space-y-2 text-lg text-blue-950 font-semibold">
                    <li>
                      พัฒนาระบบบริหารงานและระบบประกันคุณภาพภายในให้มีคุณภาพ
                    </li>
                    <li>พัฒนาบุคลากรให้มีคุณภาพตามเกณฑ์มาตรฐานวิชาชีพ</li>
                    <li>พัฒนาหลักสูตรและกระบวนการจัดการเรียนรู้ของครู</li>
                    <li>
                      พัฒนาผู้เรียนให้มีคุณภาพตามมาตรฐานการศึกษาของศักยภาพ
                    </li>
                    <li>
              ...
              <div className="space-y-3 pt-20">
                ...
                <div className="space-y-2 ">
                  <p className="indent-8">
                    ...
                    ได้เรียนตลอดชีวิตทั้งเพื่อพัฒนาด้านวิชาการ
                    และพัฒนาที่ยั่งยืน”
                  </p>
                  <p className="indent-8">
                    ผู้เรียนต้องเป็นผู้ที่มีจิตสำนึก มีความรับผิดชอบต่อตนเอง
                    ครอบครัว และสังคม ประพฤติดี อยู่ในกรอบของศีลธรรม จริยธรรม
                    มีวินัย และสามารถดำรงชีวิตในสังคมอย่างมีความสุข
                  </p>
                </div>
              </div>
            </section>
