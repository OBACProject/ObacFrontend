...
export default function PDFGenerator() {
  ...
  return <button className=" px-10 py-1 bg-white rounded-md text-center border-2 hover:bg-[#e4f1f8] border-gray-200" onClick={()=>{generatePDF(score)}}>ดาวน์โหลดเอกสาร</button>;
}
