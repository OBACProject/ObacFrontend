    ...
    <div className="max-w-6xl mx-auto px-1 lg:px-4  lg:py-6 grid gap-6">
      ...
      {data.isPublish ? (
        ...
        <div className="w-full grid place-items-center px-3 ">
          <p className="text-2xl text-red-500 bg-white w-full items-center gap-2 shadow py-5 rounded-md flex justify-center">
            <Clock className="text-red-500" /> ยังไม่ประกาศผลคะแนน
          </p>
        </div>
      )}
      {data.isPublish ?? (
