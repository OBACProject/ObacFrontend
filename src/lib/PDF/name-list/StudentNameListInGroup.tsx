...
const StudentNameListInGroupPDF = ({
  student,
  studentGroup,
  year,
}: DataList) => {
  ...
  // }
  doc.setFontSize(16);
  doc.text("ลงชื่อ.............................................", 58, y3, {
    align: "center",
  });
  doc.text("(.............................................)", 58 + 3, y3 + 6, {
    align: "center",
  });
  doc.text("กรรมการคุมสอบ", 55 + 3, y3 + 13, { align: "center" });

  doc.text("ลงชื่อ.............................................", 147, y3, {
    align: "center",
  });
  doc.text("(.............................................)", 147 + 3, y3 + 6, {
    align: "center",
  });
  doc.text("กรรมการคุมสอบ", 147 + 3, y3 + 13, { align: "center" });
