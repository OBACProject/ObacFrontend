...
const HC2_Transcript = ({ score }: Data) => {
  ...
  autoTable(doc, {
    ...
    body: [
      [
        "30000-1101",
        "ทักษะการเขีนและการพูดภาษาไทยในอาชีพ",
        "2",
        score,
        7,
        8,
      ...
      ["30000-1202", "การเขียนและนำเสนอโครงงานภาษาอังกฤษ", "1", score, 7, 8, 9, 11],
      [
        "30000-1301",
        "วิทยาศาสตร์งานอาชีพธุรกิจและบริการ",
        "3",
        score,
        7,
        8,
      ...
      ["30000-1503", "หลักปรัชญาเศรษฐกิจพอเพียง", "3", score, 7, 8, 9, 11],
      ["30202-1002", "องค์การและการบริหารงานคุณภาพ", "3", score, 7, 8, 9, 11],
      ["30202-2003", "การตลาดดิจิทัล", "3", score, 7, 8, 9, 11],
      ["30202-2008", "ผลิตภัณฑ์และราคา", "3", score, 7, 8, 9, 11],
