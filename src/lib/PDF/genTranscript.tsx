...
const GenTranscript = ({score}:Data) => {
  ...
  autoTable(doc, {
    startY: 81,
    body: [
      ["20000-1101", "ภาษาไทยเพื่อการสื่อสาร", "1",score,7,8,9,11 ],
      ["20000-1201", "ภาษาอังกฤษพื้นฐาน", "2", score,7,8,9,11],
      ["20000-1501", "คณิตศาสตร์พื้นฐาน", "2", score,7,8,9,11],
      ["20000-2001", "ประวัติศาสตร์เพื่อการท่องเที่ยว", "2", score,7,8,9,11],
      ["20000-1501", "คณิตศาสตร์พื้นฐาน", "2", score,7,8,9,11],
      ["20000-2001", "ประวัติศาสตร์เพื่อการท่องเที่ยว", "2", score,7,8,9,11],
      ["", "", "", ],
      ["", "", "", ],
